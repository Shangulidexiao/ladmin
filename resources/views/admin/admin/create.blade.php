    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            ...
            <div class="widget-body">
                <div>
                    <form id="defaultForm" role="form" action="{{ url('admin/admin/') }}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <span class="input-icon icon-right">
                                        <input type="text" class="form-control" id="userName" name="userName" value="{{ old('userName') }}" placeholder="用户名">
                            ...
                            <div class="col-sm-12 col-lg-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <span class="input-icon icon-right">
                                        <input type="text" class="form-control" id="trueName" name="trueName" value="{{ old('trueName') }}" placeholder="姓名">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <span class="input-icon icon-right">
                                        <input type="password" class="form-control" id="password" name="repassword" value="{{ old('repassword') }}" placeholder="确认密码">
                                        <i class="fa fa-lock circular"></i>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <span class="input-icon icon-right">
                                        <input type="text" class="form-control" id="mobile" name="mobile" value="{{ old('mobile') }}" placeholder="手机号">
